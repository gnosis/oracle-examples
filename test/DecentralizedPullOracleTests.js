...
//   it("Expect inputData function to input data into integerFeed, increment totalReports, and set resultsSet", async () => {
//     var currentDate = new Date().getUTCDate();
...
//     assert.equal(await _DecentralizedWeatherPullOracleFeed.integerFeed(currentDate, 0).then(res => res.toString(10)), 13);
//   });
